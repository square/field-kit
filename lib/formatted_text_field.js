...
(function() {
  ...
  FormattedTextField = (function() {
    ...
    FormattedTextField.prototype.readSelectionFromPasteboard = function(pasteboard) {
      var caret, text;
    ...
    FormattedTextField.prototype.paste = function(event) {
      var _this = this;
      event.preventDefault();
      return this.rollbackInvalidChanges(function() {
  ...
  if (typeof module !== "undefined" && module !== null) {
    ...
    (this.FieldKit || (this.FieldKit = {})).FormattedTextField = FormattedTextField;
  }
