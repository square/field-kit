...
(function() {
  ...
  FormattedTextField = (function() {
    ...
    FormattedTextField.prototype.moveUpAndModifySelection = function(event) {
      ...
      this.caret = caret;
      return this.selectionDirection = caret.start === caret.end ? DIRECTION.NONE : DIRECTION.LEFT;
    };
    ...
    FormattedTextField.prototype.moveDownAndModifySelection = function(event) {
      ...
      this.caret = caret;
      return this.selectionDirection = caret.start === caret.end ? DIRECTION.NONE : DIRECTION.RIGHT;
    };
