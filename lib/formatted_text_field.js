...
(function() {
  ...
  FormattedTextField = (function() {
    ...
    FormattedTextField.prototype.insertCharacter = function(event) {
      ...
      if (this.formatter.length && this.value.length >= this.formatter.length) {
        return;
      }
    ...
    FormattedTextField.prototype.replaceSelection = function(text) {
      var caret, value;
      caret = this.caret;
      value = this.value;
    ...
    FormattedTextField.prototype.keyPress = function(event) {
      return this.insertCharacter(event);
    };
    ...
    FormattedTextField.prototype.__defineGetter__('textToValueMapping', function() {
    ...
    FormattedTextField.prototype.__defineSetter__('caret', function(valueCaret) {
      ...
      for (textIndex in _ref) {
        ...
        if (valueCaret.start === valueIndex) {
          textCaret.start = Number(textIndex);
        }
        if (valueCaret.end === valueIndex) {
          textCaret.end = Number(textIndex);
        }
      }
