  ...
  TextField = (function() {
    ...
    function TextField(element, _formatter) {
      ...
      this._blur = function(event) {
        return TextField.prototype._blur.apply(_this, arguments);
      };
      this._focus = function(event) {
        return TextField.prototype._focus.apply(_this, arguments);
      };
      this.click = function(event) {
        return TextField.prototype.click.apply(_this, arguments);
      };
      this.paste = function(event) {
        return TextField.prototype.paste.apply(_this, arguments);
      };
