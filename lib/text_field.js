...
var TextField = (function (_Input) {
  ...
  function TextField(element, formatter) {
    ...
    var caret = _caret2['default'].get(element);
  ...
  _createClass(TextField, [{
    ...
    value: function selectedRange() {
      var caret = this._needsManualCaret ? this._manualCaret : _caret2['default'].get(this.element);
    ...
    value: function setSelectedRangeWithAffinity(range, affinity) {
      ...
      _caret2['default'].set(this.element, caret.start, caret.end);
    ...
    value: function _click() {
      this._manualCaret = _caret2['default'].get(this.element);
      this._selectedRange = {
