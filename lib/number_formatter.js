...
class NumberFormatter extends Formatter {
   ...
   */
  negativePrefix() {
    return replaceCurrencySymbol(this._get('negativePrefix'), this.currencySymbol());
  }
   ...
   */
  negativeSuffix() {
    return replaceCurrencySymbol(this._get('negativeSuffix'), this.currencySymbol());
  }
   ...
   */
  positivePrefix() {
    return replaceCurrencySymbol(this._get('positivePrefix'), this.currencySymbol());
  }
   ...
   */
  positiveSuffix() {
    return replaceCurrencySymbol(this._get('positiveSuffix'), this.currencySymbol());
  }
...
var LocaleDefaults = {
  ...
  ja: {
    negativeCurrencyPrefix: formatter => formatter.minusSign() + '¤',
    negativeCurrencySuffix: ''
  },
  'en-GB': {
    negativeCurrencyPrefix: formatter => formatter.minusSign() + '¤',
