...
b[d],d,b)}function Fa(b){var a;if(null===b||void 0===b)return[];var d=ma(b);for(b=b.constructor&&b.constructor.prototype;b;)(a=d).push.apply(a,Ga.call(ma(b))),b=Ha(b);return d}function Ia(b){var a="OSX"===b,d=a?q:C;T[b]||(T[b]=Ja(b,function(g){g(Ka,d,"selectAll");g(y,null,"moveLeft");g(y,p,"moveWordLeft");g(y,l,"moveLeftAndModifySelection");g(y,p|l,"moveWordLeftAndModifySelection");g(z,null,"moveRight");g(z,p,"moveWordRight");g(z,l,"moveRightAndModifySelection");g(z,p|l,"moveWordRightAndModifySelection");
g(A,null,"moveUp");g(A,p,"moveToBeginningOfParagraph");g(A,l,"moveUpAndModifySelection");g(A,p|l,"moveParagraphBackwardAndModifySelection");g(B,null,"moveDown");g(B,p,"moveToEndOfParagraph");g(B,l,"moveDownAndModifySelection");g(B,p|l,"moveParagraphForwardAndModifySelection");g(u,null,"deleteBackward");g(u,l,"deleteBackward");g(u,p,"deleteWordBackward");g(u,p|l,"deleteWordBackward");g(u,d,"deleteBackwardToBeginningOfLine");g(u,d|l,"deleteBackwardToBeginningOfLine");g(na,null,"deleteForward");g(na,
p,"deleteWordForward");g(U,null,"insertTab");g(U,l,"insertBackTab");g(oa,null,"insertNewline");g(pa,d,"undo");a?(g(y,q,"moveToBeginningOfLine"),g(y,q|l,"moveToBeginningOfLineAndModifySelection"),g(z,q,"moveToEndOfLine"),g(z,q|l,"moveToEndOfLineAndModifySelection"),g(A,q,"moveToBeginningOfDocument"),g(A,q|l,"moveToBeginningOfDocumentAndModifySelection"),g(B,q,"moveToEndOfDocument"),g(B,q|l,"moveToEndOfDocumentAndModifySelection"),g(u,C,"deleteBackwardByDecomposingPreviousCharacter"),g(u,C|l,"deleteBackwardByDecomposingPreviousCharacter"),
g(pa,q|l,"redo")):g(La,C,"redo")}));return T[b]}function Ja(b,a){var d=new Ma(b);a(function(){var a=[].slice.call(arguments,0);return d.bind.apply(d,Na.call(a))});return d}function H(b){return b&&/^\w$/.test(b)}function Oa(b){var a=(new Date).getFullYear(),d=a-a%100,d=[d,d-100,d+100].sort(function(d,c){return Math.abs(a-(b+d))-Math.abs(a-(b+c))});return b+d[0]}function V(b){var a=b.length;if(0===a)return"1";var d=parseInt(b[a-1],10);return 9===d?V(b.slice(0,a-1))+"0":b.slice(0,a-1)+(d+1)}function I(b,
...
La=89,pa=90,y=37,z=39,A=38,B=40,u=8,na=46,U=9,oa=13,$a=u,xa=U,ab=oa,C=1,q=2,p=4,l=8,T={},Ma=function(){function b(a){this.platform=a;this.bindings={}}wa(b.prototype,"bind",{value:function(a,d,b){this.bindings[a]||(this.bindings[a]={});this.bindings[a][d||0]=b},enumerable:!1,writable:!0});wa(b.prototype,"actionForEvent",{value:function(a){var d=this.bindings[a.keyCode];if(d){var b=0;a.altKey&&(b|=p);a.ctrlKey&&(b|=C);a.metaKey&&(b|=q);a.shiftKey&&(b|=l);return d[b]}},enumerable:!1,writable:!0});return b}(),
